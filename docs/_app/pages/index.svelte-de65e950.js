...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("colors" in $$props2)
      $$invalidate(5, colors2 = $$props2.colors);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & 32) {
      $$invalidate(1, btns = colors2.map((color) => ({ color })).concat([{ text: "#", modal: true }]));
    }
  };
  return [show, btns, close, selectColor, event, colors2, click_handler];
}
class EditorColorPicker extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$2, safe_not_equal, { show: 0, btns: 1, event: 4, colors: 5 });
  }
}
...
function create_each_block(ctx) {
  ...
  return {
    ...
    h() {
      set_style(li, "color", colors[ctx[2]], false);
    },
    m(target, anchor) {
...
function create_fragment(ctx) {
  ...
  let t17;
  let t18_value = `
        import { colors } from "@douganderson444/svelte-editable-action"
        `;
  let t18;
  let t19;
  let t20;
  ...
  return {
    c() {
      div1 = element("div");
      h1 = element("h1");
      t0 = text("Svelte Text Editor Usage & Guide");
      t1 = text("\r\n	Click \u{1F5B1}\uFE0F on me to\r\n	");
      i0 = element("i");
      t2 = text("edit this");
      t3 = space();
      b0 = element("b");
      ...
      h2 = element("h2");
      t9 = text("click me:");
      t10 = text("\r\n		Custom Fonts are editable too!");
      t11 = space();
      p0 = element("p");
      t12 = text("Just add the css in your svelte style section as usual");
      t13 = space();
      for (let i = 0; i < each_blocks.length; i += 1) {
        each_blocks[i].c();
      }
      t14 = space();
      p1 = element("p");
      t15 = text("That's ok, just add your own colors or import it from the module");
      t16 = space();
      pre = element("pre");
      t17 = text("        ");
      t18 = text(t18_value);
      ...
      t23 = space();
      i1 = element("i");
      t24 = text("You can use the same color for multiple elements, just add the same color to the array\r\n			multiple times");
      this.h();
    },
    l(nodes) {
      ...
      t9 = claim_text(h2_nodes, "click me:");
      ...
      t12 = claim_text(p0_nodes, "Just add the css in your svelte style section as usual");
      ...
      t15 = claim_text(p1_nodes, "That's ok, just add your own colors or import it from the module");
      p1_nodes.forEach(detach);
      t16 = claim_space(div1_nodes);
      pre = claim_element(div1_nodes, "PRE", {});
      var pre_nodes = children(pre);
      t17 = claim_text(pre_nodes, "        ");
      t18 = claim_text(pre_nodes, t18_value);
      ...
      t21 = claim_text(b1_nodes, "Note:");
      b1_nodes.forEach(detach);
      t22 = claim_space(p2_nodes);
      br = claim_element(p2_nodes, "BR", {});
      t23 = claim_space(p2_nodes);
      i1 = claim_element(p2_nodes, "I", {});
      var i1_nodes = children(i1);
      t24 = claim_text(i1_nodes, "You can use the same color for multiple elements, just add the same color to the array\r\n			multiple times");
    ...
    h() {
      attr(h1, "class", "svelte-xje7yh");
      attr(a, "href", "https://twitter.com/DougAnderson444");
      attr(a, "target", "_blank");
      attr(input, "type", "text");
      attr(input, "placeholder", "Clicking an input does not affect editing");
      attr(input, "class", "svelte-xje7yh");
      set_style(input, "width", `20em`, false);
      attr(h2, "class", "lucky svelte-xje7yh");
      set_style(div0, "display", `block`, false);
    },
    m(target, anchor) {
      ...
      append_hydration(p2, br);
      append_hydration(p2, t23);
      append_hydration(p2, i1);
      append_hydration(i1, t24);
      if (!mounted) {
        dispose = action_destroyer(editable.call(null, div1, { colors }));
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      if (dirty & 0) {
        each_value = comment.split(" ");
        let i;
        for (i = 0; i < each_value.length; i += 1) {
...
let comment = "But I want custom colors!";
